root_folder = "waferflaskawsmlops"
root_file_training_path="company_name/training/data/project"
root_file_prediction_path="company_name/prediction/data/project"
root_archive_training_path="company_name/training/archive/project"
root_archive_prediction_path="company_name/prediction/archive/project"
root_graph_path="company_name/report/graph/project"
from webapp.data_access_layer.mongo_db.mongo_db_atlas import MongoDBOperation as MongoDB
mongodb = MongoDB()

def get_watcher_input_file_path(project_id):
    return "company_name/training/data/project/project_id_{}".format(project_id)
