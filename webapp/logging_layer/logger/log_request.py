...
from webapp.data_access_layer.cassandra_database.cassandra_database_manager import CassandraDatabaseManager
import uuid
import sys
...
class LogRequest:
    def __init__(self,executed_by=None, execution_id=None):
        ...
        self.cassandra_db_object=CassandraDatabaseManager()
    ...
    def log_start(self,request):
        ...
        try:
            ...
            #response=self.cassandra_db_object.create_document(collection_name=self.log_collection_name,document=log_data)
            #self.document_id=response['documentId']
        except Exception as e:
            app_logger_exception = AppLoggerException(
